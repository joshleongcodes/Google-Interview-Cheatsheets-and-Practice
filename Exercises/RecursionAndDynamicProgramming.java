class RecursionAndDynamicProgramming {
    ...
    /*
     * Recursion and Dynamic Programming Interview Questions:
     * Page 134-136 of Cracking the Coding Interview.
     */

     /*
     * Interview Question 8.1: Triple Step. 
     * A child is running up a staircase with n steps and can hop either 1 step, 2 steps, or 3 steps at a time. 
     * Implement a method to count how many possible ways the child can run up the stairs.
     */

    /*
    * Interview Question 8.2: Robot in a Grid.
    ...
    */
    ...
    /*
    * Interview Question 8.3: Magic Index.
    ...
    */
    ...
    /*
     * Interview Question 8.7: Permutations without Dups.
     * Permutations without Dups: Write a method to compute all permutations of a string of unique characters.
     */

     /*
      * Interview Question 8.8: Permutations with Dups: 
      * Write a method to compute all permutations of a string whose charac- ters are not necessarily unique. 
      * The list of permutations should not have duplicates.
      */
    
    /*
     * Interview Question 8.9: Parens.
    ...
    /*
     * Interview Question 8.10: Paint Fill.
    ...
    /*
     * Interview Question 8.11: Coins.
     * Given an innnite number of quarters (25 cents), dimes (10 cents), nickels (5 cents), and pennies (1 cent), 
     * write code to calculate the number of ways of representing n cents.
     */

    /*
     * Interview Question 8.12: Eight Queens.
    ...
    /*
     * Interview Question 8.13: Stack of Boxes.
     ...
     * if each box in the stack is strictly larger than the box above it in width, height, and depth. Implement a method to compute the height of the 
     * tallest possible stack.The height of a stack is the sum of the heights of each box.
     */

    /*
     * Interview Question 8.14: Boolean Evaluation.
     * Given a boolean expression consisting of the symbols e (false), 1 (true), & (AND), I (OR), and" (XOR), and a desired boolean result value result, 
